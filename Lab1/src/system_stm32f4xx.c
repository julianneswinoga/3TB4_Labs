/**
  ...
  *          configuration below:
  *            - PLL_SOURCE_HSI                : HSI (~16MHz) used to clock the
  *PLL, and
  *                                              the PLL is used as system clock
  *source.
  *            - PLL_SOURCE_HSE                : HSE (8MHz) used to clock the
  *PLL, and
  *                                              the PLL is used as system clock
  *source.
  *            - PLL_SOURCE_HSE_BYPASS(default): HSE bypassed with an external
  *clock
  *                                              (8MHz, coming from ST-Link)
  *used to clock
  *                                              the PLL, and the PLL is used as
  *system
  *                                              clock source.
  *
...
//#define PLL_SOURCE_HSI        // HSI (~16 MHz) used to clock the PLL, and the
// PLL is used as system clock source
#define PLL_SOURCE_HSE // HSE (8MHz) used to clock the PLL, and the PLL is used
					   // as system clock source
//#define PLL_SOURCE_HSE_BYPASS   // HSE bypassed with an external clock (8MHz,
// coming from ST-Link) used to clock
...
/**
  ...
  *         This function configures the external SDRAM mounted on
 * STM324x9I_EVAL board
